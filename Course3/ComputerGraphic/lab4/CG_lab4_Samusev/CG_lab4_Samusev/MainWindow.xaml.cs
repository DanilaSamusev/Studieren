...
namespace CG_lab4_Samusev
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void CreateFigureButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _imageSideLength = 210;
            }

            bitmap = new WriteableBitmap(_imageSideLength + 10, _imageSideLength + 10, 96, 96, PixelFormats.Bgr32, null);
            ImageBox.Source = bitmap;

            DrawEllipse(_imageSideLength / 2, _imageSideLength / 14 * 9, _imageSideLength / 14 * 3, _imageSideLength / 7, Quarter.First, Quarter.Second);
            DrawEllipse(_imageSideLength / 2, _imageSideLength / 14 * 9, _imageSideLength / 14 * 5, _imageSideLength / 7 * 2, Quarter.First, Quarter.Second);

            DrawLine(new Line
            {
                X1 = _imageSideLength / 7,
                Y1 = _imageSideLength / 14 * 9,
                X2 = _imageSideLength / 7 * 2,
                Y2 = _imageSideLength / 14 * 9
            });

            DrawLine(new Line
            {
                X1 = _imageSideLength / 14 * 13,
                Y1 = _imageSideLength / 14 * 9,
                X2 = _imageSideLength / 7 * 6,
                Y2 = _imageSideLength / 14 * 9
            });

            DrawLine(new Line
            {
                X1 = _imageSideLength / 7 * 5,
                Y1 = _imageSideLength / 14 * 9,
                X2 = _imageSideLength / 14 * 9,
                Y2 = _imageSideLength / 14 * 9
            });
            ...
            DrawLine(new Line
            {
                X1 = _imageSideLength / 14 * 13,
                Y1 = _imageSideLength / 14 * 9,
                X2 = _imageSideLength / 14 * 11,
                Y2 = _imageSideLength / 14 * 11
            });

            DrawLine(new Line
            {
                X1 = _imageSideLength / 14 * 9,
                Y1 = _imageSideLength / 14 * 9,
                X2 = _imageSideLength / 14 * 11,
                Y2 = _imageSideLength / 14 * 11
            });
